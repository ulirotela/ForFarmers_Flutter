...
import 'package:farmapp/widgets/ad_banner_widget.dart';
import 'package:farmapp/widgets/categories_horizontal_list_view_bar.dart';
import 'package:farmapp/widgets/loading_widget.dart';
import 'package:farmapp/widgets/products_showcase_list_view.dart';
                  ...
                  child: Column(
                    children: [
                      ...
                      ProductsShowcaseListView(
                          title: "Vegetables 70% Disccount", children:  discount70!),
                      ProductsShowcaseListView(
                          title: "Fruits 60% Disccount", children: discount60!), 
                      ProductsShowcaseListView(
                          title: "Tools 50% Disccount", children: discount50!),
                      ProductsShowcaseListView(
                          title: "Others", children: discount0!),
                    ],
                  ),
                ),
                UserDetailsBar(
